...
async function create(usuario,token){
       if(usuario.id_tipo_usuario == -1){
            ...
            if(usuario.creadoCon && usuario.creadoCon=="google"){
                  contentHtml = `<center>
                  <img src="https://firebasestorage.googleapis.com/v0/b/dory-prod-d7a48.appspot.com/o/logo-no-bg.png?alt=media&token=175241fc-7aae-490c-9236-191629166235" style='width: 80px; height: 80px;'/>
