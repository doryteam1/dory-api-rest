...
async function getMultiple(page = 1, email){
    ...
    let message = "Usuario no esta registrado";
        ...
        const rows = await db.query(
          ...
          u.latitud,u.longitud,u.nombre_corregimiento,u.nombre_vereda,u.estaVerificado,u.otra_area_experticia,u.otra_area_experticia_descripcion,u.sobre_mi, u.takeTour, u.url_imagen_cedula, u.url_sisben
